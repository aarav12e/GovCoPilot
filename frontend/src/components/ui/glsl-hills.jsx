...
export const GLSLHills = ({ width = '100%', height = '100%', cameraZ = 125, planeSize = 256, speed = 0.5, className }) => {
        ...
        class Plane {
            ...
            `,
              ...
              void main(void) {
                ...
                // Giving the hills a subtle orange/indigo tint to match the theme
    ...
    return (
        <div ref={containerRef} className={cn("relative overflow-hidden pointer-events-none", className)} style={{ width, height }}>
            <canvas
                ref={canvasRef}
